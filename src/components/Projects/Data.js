export const homeObjOne = {
    ...
    description2:
        'Picked up on new technologies (Nest js, TypeORM, React Hooks) to add structure for fast development process.' +
        ' Required reading documentations, articles, and referencing videos.',
    descriptionTitle3: 'What I did in the project',
    description3:
        'Developed a full-stack app by myself for the first time. Built frontend using react and used jwt for ' +
